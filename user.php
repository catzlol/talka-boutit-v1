...
<!DOCTYPE html>
  ...
  //Do nonthing.
    ...
    ?>
    <title><?php echo $userRow['username']; ?> - Talka-boutit.</title>
  <meta charset="UTF-8">
  ...
  <meta property="og:description" content="<?php echo $userRow['username'] ?> is a user on Talkaboutit. The free discussion site. Sign up today to get started!" />
  ...
  <meta property="og:url" content="http://www.madblxx.ga/user?id=<?php echo $userRow['id'] ?>" />
  </head>
  <body>
    ...
    ?>
      ...
      <h5>Right now I\'m:</h5><p style="margin:5px;"">'. htmlspecialchars($currStatus) .'</p>';
