<?php
  ...
  echo '<head><title>Users - PolyDura</title></head>';
?>
  ...
  <body>
    <div id="body">
      <div id="box" style="text-align:center;">
        ...
        ?>
        <span>
          <a href="http://localhost/users/online" style="color: #09bd00;font-size: 12px;float: right;margin-right: 20px;padding-top: 3px;">Online Users</a>
          <a href="http://localhost/users/users" style="color: #000;font-size: 12px;float: right;margin-right: 20px;margin-left:20px;padding-top: 3px;">Users</a>
        </span>
        </dv>
      </div>
    </div>
