<?php
  ...
  if (isset($_GET['search'])) {
    echo '<head><title>\'' . $_GET['search'] . '\' Search - PolyDura</title></head>';}
  else {
      ...
      <div id="box" style="text-align:center;">
        ...
        if (isset($_GET['search'])) {
          ...
          while($searchRow=$result->fetch_assoc()){
            ...
            echo '<tr class="searchColumn"><td><img style="vertical-align:middle; width:40px;" src="/images/avatars/'?><?php echo $searchRow["id"]; ?><?php echo '.png?c='?><?php echo $searchRow['avatar_id']; ?><?php echo '">';
