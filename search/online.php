      ...
      <div id="box" style="text-align:center;">
        ...
        <?php
          ...
          while($searchRow=$result->fetch_assoc()){ 
            ...
            if ($lastonline <= 300) {
            echo '<tr class="searchColumn"><td><img style="vertical-align:middle; width:40px;" src="/images/avatars/'?><?php echo $searchRow["id"];
            echo '.png?c=';
        ...
        ?>
        <span>
          <a href="/users/online" style="color: #09bd00;font-size: 12px;float: right;margin-right: 20px;padding-top: 3px;">Online Users</a>
          <a href="/users/?search" style="color: #0;font-size: 12px;float: right;margin-right: 20px;padding-top: 3px;">Users</a>
        </div>
        </span>
      </div>
    </div>
