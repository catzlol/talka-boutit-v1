...
<!DOCTYPE html>
  <head>
    <title>Appeal a Moderation action</title>
  </head>
  <body>
    <div id="body">
      <div id="box">
        ...
        if(!isset($_POST['report'])) {
          ...
          <form action="report" method="POST">
            ...
            <h5>Reason:</h5>
            <textarea name="Reason for your appeal" style="margin:5px;width:310px;height:150px;"></textarea><br>
          ...
          echo '<div style="padding:10px;">
          <h3>Your appeal will be reviewed shortly</h3>
          </div>';
        }
        ?>
      </div>
