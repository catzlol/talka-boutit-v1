...
<div id="box" style="margin-bottom:10px">
  ...
  <!-- New Section for Subtalks and Forum Posts -->
  <h4>Forum and Subtalks</h4>
  <form action="" method="POST" style="margin:10px;">
    <label>Subtalk ID (Optional):</label><br>
    <input type="text" name="subtalk_id"><br>
    <label>Forum Post ID (Optional):</label><br>
    <input type="text" name="forum_post_id"><br>
    <input type="submit" name="add_content" value="Add Content to Ban">
  </form>
</div>
</div>
?>
