<?php
    ...
    if(isset($_GET['delete_subtalk'])) {
      $subtalkID = mysqli_real_escape_string($conn,$_GET['delete_subtalk']);
      $deleteSubtalkSQL = "DELETE FROM `forum_boards` WHERE `id`='$subtalkID'";
      $deleteSubtalk = $conn->query($deleteSubtalkSQL);
      header("Location: index");
    }
...
<body>
  ...
  <div id="body">
    ...
    <div id="column" style="float:right;width:695px;" class="page">
      ...
      } else if (isset($_GET['delete_subtalks'])) { // New Page
        include('pages/delete_subtalks.php');
      } else {
