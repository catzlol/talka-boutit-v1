    ...
    <div id="body">
      <div id="box">
        ...
        <?php
                ...
                $otherUser = mysqli_fetch_array($otherUserDetails);
                  ...
                  <div style='margin:10px;'>
                    <div style='padding:2px;float: left;'>
                      <img src='/images/avatars/$otherUser[id].png?c=".$otherUser['avatar_id']."' width='80px'><br>
          ...
          if (mysqli_num_rows($friendsList) > 0) {
              ...
              $friendRowQ = mysqli_query($conn,"SELECT * FROM `beta_users` WHERE (`id`='$friendsListRow[from_id]' OR `id`='$friendsListRow[to_id]') AND `id`!='$userID'");
                  ...
                  echo "
                    <div style='margin:10px;'>
                        <div style='padding:2px;float: left;'>
                          <img src='/images/avatars/$friendRow[id].png?c=".$friendRow['avatar_id']."' width='80px'><br>
          ...
          <style>
  img {
    max-width: 50px; /* You can adjust this value to your desired maximum width */
    height: auto;
  }
</style>
