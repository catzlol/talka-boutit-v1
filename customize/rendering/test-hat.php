...
<html>
  ...
  <body>
    ...
    scene.add( directionalLight );
        ...
        loader.load( '/shop/assets/faces/face.png' , function ( faceimg ) {
          facetex.image = faceimg;
          facetex.needsUpdate = true;
        } );
        loader.load( '/shop/assets/tshirts/0.png' , function ( tshirtimg ) {
          tshirttex.image = tshirtimg;
          tshirttex.needsUpdate = true;
        } );
        loader.load( '/shop/assets/shirts/0.png' , function ( shirtimg ) {
          shirttex.image = shirtimg;
          shirttex.needsUpdate = true;
        } );
        loader.load( '/shop/assets/pants/0.png' , function ( pantsimg ) {
          pantstex.image = pantsimg;
          pantstex.needsUpdate = true;
        } );
        loader.load( '/shop/assets/hats/0.png' , function ( hat1img ) {
          hat1tex.image = hat1img;
          hat1tex.needsUpdate = true;
        } );
        loader.load( '/shop/assets/hats/0.png' , function ( hat2img ) {
          hat2tex.image = hat2img;
          hat2tex.needsUpdate = true;
        } );
        loader.load( '/shop/assets/hats/0.png' , function ( hat3img ) {
          hat3tex.image = hat3img;
          hat3tex.needsUpdate = true;
        } );
        loader.load( '/shop/assets/hats/0.png' , function ( hat4img ) {
          hat4tex.image = hat4img;
          hat4tex.needsUpdate = true;
        } );
        loader.load( '/shop/assets/hats/0.png' , function ( hat5img ) {
          hat5tex.image = hat5img;
          hat5tex.needsUpdate = true;
        } );
        loader.load( '/shop/assets/tools/0.png' , function ( toolimg ) {
